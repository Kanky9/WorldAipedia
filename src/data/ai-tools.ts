...
export const aiTools: AITool[] = [
  ...
  },
  {
    id: 'midjourney',
    title: 'Midjourney',
    shortDescription: 'AI image generation from text prompts with an artistic focus.',
  ...
  },
  {
    ...
    shortDescription: 'Your AI pair programmer for faster coding.',
  ...
  },
  {
    id: 'synthesia',
    title: 'Synthesia',
    shortDescription: 'AI video generation platform with avatars.',
  ...
  },
  {
    id: 'grammarly',
    title: 'Grammarly',
    shortDescription: 'AI-powered writing assistant for clarity and correctness.',
  ...
  },
  {
    ...
    shortDescription: 'Open-source text-to-image generation model.',
  ...
  },
  {
    id: 'runwayml',
    title: 'RunwayML',
    shortDescription: 'AI magic tools for video editing and content creation.',
    longDescription: 'RunwayML offers a suite of AI-powered tools for creators, including advanced video editing features like text-to-video, image-to-video, background removal, and generative art.',
    imageUrl: 'https://placehold.co/600x400.png',
  ...
  },
  {
    ...
    longDescription: 'Jasper is an AI writing tool that helps you create high-quality content for blogs, social media, websites, and marketing campaigns. It uses advanced AI to generate creative and persuasive text.',
    imageUrl: 'https://placehold.co/600x400.png',
  ...
  },
  {
    id: 'otter-ai',
    title: 'Otter.ai',
    shortDescription: 'AI-powered transcription service for voice conversations.',
    longDescription: 'Otter.ai provides real-time transcription for meetings, interviews, and lectures. It uses AI to generate rich notes with speaker identification, summaries, and keyword extraction.',
    imageUrl: 'https://placehold.co/600x400.png',
    imageHint: 'voice transcription',
    logoUrl: 'https://placehold.co/50x50.png',
    logoHint: 'Otter icon',
    category: 'Audio',
    link: 'https://otter.ai/',
  },
  {
    ...
    shortDescription: 'High-quality AI-powered language translation.',
    longDescription: 'DeepL is renowned for its nuanced and accurate translations. It supports multiple languages and offers services for individuals and businesses, providing natural-sounding translations.',
    imageUrl: 'https://placehold.co/600x400.png',
