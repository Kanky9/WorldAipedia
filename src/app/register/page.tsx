...
import { UserPlus, Mail, KeyRound } from 'lucide-react'; // Import icons

// Mock social login icons
...
export default function RegisterPage() {
  ...
  const handleRegister = (event: React.FormEvent) => {
    ...
    alert(t('registrationAttemptMessage', 'Registration attempt (simulated)'));
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            <div>
              ...
              <div className="relative mt-1">
                ...
                <Input id="username" name="username" type="text" autoComplete="username" required placeholder={t('usernamePlaceholder', 'Choose a username')} className="pl-10" />
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <Input id="password" name="password" type="password" autoComplete="new-password" required placeholder="••••••••" className="pl-10" />
              </div>
            </div>
             <div>
              ...
              <div className="relative mt-1">
                <KeyRound className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground" />
                <Input id="confirm-password" name="confirm-password" type="password" required placeholder="••••••••" className="pl-10" />
              </div>
            </div>
            <Button type="submit" className="w-full bg-primary text-primary-foreground hover:bg-primary/90">
               <UserPlus className="mr-2 h-5 w-5" />{t('registerButton', 'Sign Up')}
            </Button>
          </form>
          <div className="mt-6">
