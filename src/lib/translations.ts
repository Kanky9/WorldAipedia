...
export type CoreTranslationKey =
  ...
  | 'adminManageStoreTitle'
  | 'adminManageStoreDescription'
  | 'adminCreateNewProductButton'
  | 'adminProductSourceLabel'
  ...
  | 'adminProductCreatedSuccess'
  | 'adminProductUpdatedSuccess'
  | 'adminProductDeleteSuccessTitle'
  ...
  | 'cancelSubscriptionSuccessTitle'
  | 'cancelSubscriptionSuccessDesc'
  | 'cancelSubscriptionErrorTitle'
  | 'cancelSubscriptionErrorDesc'
...
export const translations: Translations = {
  en: {
    ...
    adminManageStoreTitle: 'Manage Store',
    adminManageStoreDescription: 'Add, edit, or remove store products.',
    adminCreateNewProductButton: 'Add New Product',
    adminProductSourceLabel: 'Source',
    ...
    adminProductCreatedSuccess: 'Product Created',
    adminProductUpdatedSuccess: 'Product Updated',
    adminProductDeleteSuccessTitle: 'Product Deleted',
    ...
    nextBillingDateLabel: 'Access valid until',
    ...
    cancelSubscriptionSuccessDesc: 'Your PRO subscription will be active until the end of the current period.',
    cancelSubscriptionErrorTitle: 'Cancellation Failed',
    cancelSubscriptionErrorDesc: 'Could not cancel your subscription. Please contact support.',
    ...
    upgradeToProDescriptionDialog: "Unlock exclusive features, enhanced support, and a better experience.",
  ...
  es: {
    ...
    adminManageStoreTitle: 'Gestionar Tienda',
    adminManageStoreDescription: 'Añadir, editar o eliminar productos de la tienda.',
    adminCreateNewProductButton: 'Añadir Nuevo Producto',
    adminProductSourceLabel: 'Fuente',
    ...
    adminProductCreatedSuccess: 'Producto Creado',
    adminProductUpdatedSuccess: 'Producto Actualizado',
    adminProductDeleteSuccessTitle: 'Producto Eliminado',
    ...
    nextBillingDateLabel: 'Acceso válido hasta',
    ...
    cancelSubscriptionSuccessDesc: 'Tu suscripción PRO permanecerá activa hasta el final del período actual.',
    cancelSubscriptionErrorTitle: 'Error al Cancelar',
    cancelSubscriptionErrorDesc: 'No se pudo cancelar tu suscripción. Por favor, contacta con soporte.',
    ...
    upgradeToProDescriptionDialog: "Desbloquea funciones exclusivas, soporte mejorado y una mejor experiencia.",
  ...
  it: {
    ...
    adminManageStoreTitle: 'Gestisci Negozio',
    adminManageStoreDescription: 'Aggiungi, modifica o rimuovi prodotti del negozio.',
    adminCreateNewProductButton: 'Aggiungi Nuovo Prodotto',
    adminProductSourceLabel: 'Fonte',
    ...
    adminProductCreatedSuccess: 'Prodotto Creato',
    adminProductUpdatedSuccess: 'Prodotto Aggiornato',
    adminProductDeleteSuccessTitle: 'Prodotto Eliminato',
    ...
    nextBillingDateLabel: 'Accesso valido fino al',
    ...
    cancelSubscriptionSuccessTitle: 'Abbonamento Annullato',
    cancelSubscriptionSuccessDesc: 'Il tuo abbonamento PRO rimarrà attivo fino alla fine del periodo corrente.',
    cancelSubscriptionErrorTitle: 'Annullamento Fallito',
    cancelSubscriptionErrorDesc: 'Impossibile annullare il tuo abbonamento. Contatta l\'assistenza.',
  ...
  zh: {
    ...
    adminManageStoreTitle: '管理商店',
    adminManageStoreDescription: '添加、编辑或删除商店产品。',
    adminCreateNewProductButton: '添加新产品',
    adminProductSourceLabel: '来源',
    ...
    adminProductCreatedSuccess: '产品已创建',
    adminProductUpdatedSuccess: '产品已更新',
    adminProductDeleteSuccessTitle: '产品已删除',
    ...
    cancelSubscriptionSuccessTitle: '订阅已取消',
    cancelSubscriptionSuccessDesc: '您的PRO订阅将在当前周期结束前保持有效。',
    cancelSubscriptionErrorTitle: '取消失败',
    cancelSubscriptionErrorDesc: '无法取消您的订阅。请联系支持。',
    ...
    upgradeToProDescriptionDialog: "解锁独家功能、增强支持和更好的体验。",
  ...
  ja: {
    ...
    adminManageStoreTitle: 'ストアを管理',
    adminManageStoreDescription: 'ストアの商品を追加、編集、削除します。',
    adminCreateNewProductButton: '新しい商品を追加',
    adminProductSourceLabel: 'ソース',
    ...
    adminProductCreatedSuccess: '商品が作成されました',
    adminProductUpdatedSuccess: '商品が更新されました',
    adminProductDeleteSuccessTitle: '商品が削除されました',
    ...
    cancelSubscriptionSuccessTitle: 'サブスクリプションがキャンセルされました',
    cancelSubscriptionSuccessDesc: 'PROサブスクリプションは現在の期間の終わりまで有効です。',
    cancelSubscriptionErrorTitle: 'キャンセルに失敗しました',
    cancelSubscriptionErrorDesc: 'サブスクリプションをキャンセルできませんでした。サポートにお問い合わせください。',
    ...
    upgradeToProDescriptionDialog: "限定機能、強化されたサポート、より良い体験をアンロック。",
  ...
  pt: {
    ...
    adminManageStoreTitle: 'Gerenciar Loja',
    adminManageStoreDescription: 'Adicione, edite ou remova produtos da loja.',
    adminCreateNewProductButton: 'Adicionar Novo Produto',
    adminProductSourceLabel: 'Fonte',
    ...
    adminProductCreatedSuccess: 'Produto Criado',
    adminProductUpdatedSuccess: 'Produto Atualizado',
    adminProductDeleteSuccessTitle: 'Produto Excluído',
    ...
    nextBillingDateLabel: 'Acesso válido até',
    ...
    cancelSubscriptionSuccessTitle: 'Assinatura Cancelada',
    cancelSubscriptionSuccessDesc: 'Sua assinatura PRO permanecerá ativa até o final do período atual.',
    cancelSubscriptionErrorTitle: 'Falha no Cancelamento',
    cancelSubscriptionErrorDesc: 'Não foi possível cancelar sua assinatura. Entre em contato com o suporte.',
    ...
    upgradeToProDescriptionDialog: "Desbloqueie recursos exclusivos, suporte aprimorado e uma experiência melhor.",
