...
'use server';
/**
 * @fileOverview A Genkit flow to provide a welcome message and explanation for World AI.
 *
...
const PageExplainerOutputSchema = z.object({
  explanation: z.string().describe('A welcoming message that briefly explains what World AI is about, in the specified language.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a friendly and helpful AI assistant for a website called World AI.
Your goal is to greet the user and provide a very brief, welcoming explanation of what World AI is.
World AI is a site where users can discover, explore, and learn about various AI tools, neatly categorized.
...
For example, if language is "en": "Hello! Welcome to World AI, your guide to discovering the amazing world of AI tools. Explore different categories to find the perfect AI for your needs!"
If language is "es": "¡Hola! Bienvenido/a a World AI, tu guía para descubrir el increíble mundo de las herramientas de IA. ¡Explora diferentes categorías para encontrar la IA perfecta para tus necesidades!"
